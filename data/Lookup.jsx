...
export default {
  ...
  SIGNIN_HEADING: 'Continue With WebCraft',
  SIGNIN_SUBHEADING: 'To use WebCraft you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using WebCraft, you agree to the collection of usage data for analytics.',
  LINKEDIN_LINK: 'https://www.linkedin.com/in/sarabjot-singh-93256b22b/',
  GITHUB_LINK: 'https://github.com/ricky-aufvaa',
